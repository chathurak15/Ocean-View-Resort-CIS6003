...
<body class="bg-gray-50 flex h-screen overflow-hidden" data-page="reservations">
  ...
  <main class="flex-1 flex flex-col">
    ...
    <div class="flex-1 p-8 overflow-y-auto bg-gray-50/50 relative">
      <!-- Loader -->
      <div id="loader" class="hidden absolute inset-0 bg-white/50 backdrop-blur-sm z-40 flex items-center justify-center">
